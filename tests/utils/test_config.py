...
from datalineup_engine.config import Config as DatalineupConfig
from datalineup_engine.config import default_client_config
from datalineup_engine.config import default_config
from datalineup_engine.utils.config import Config
...
def test_default_config() -> None:
    ...
    config = DatalineupConfig().load_object(default_config)
    assert config


def test_default_client_config() -> None:
    config = DatalineupConfig().load_object(default_client_config)
    assert config
