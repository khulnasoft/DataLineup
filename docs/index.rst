..
   Datalineup documentation master file, created by
...
Welcome to **Datalineup** documentation. **Datalineup** is a Python framework to run and
orchestrate job pipelines. It's developed by `Khulnasoft <https://khulnasoft.io>`_ as their core
