...
The pages in this section of the documentation are aimed at the newcomer to Datalineup.
They're designed to help you get started quickly, and show how easy it is to work with
Datalineup as a developer who wants to customise it and get it working according to their
own requirements.
...
The tutorials follow a logical progression, starting from installation of Datalineup and the
...
You'll be able to find support and help in the official `Datalineup project
<https://github.com/KhulnaSoft/datalineup/>`_.
