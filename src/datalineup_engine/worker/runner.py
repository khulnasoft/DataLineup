...
def standalone_config(config: Config) -> Config:
    ...
    try:
        base_services.remove("datalineup_engine.worker.services.api_client.ApiClient")
        services.remove("datalineup_engine.worker.services.databases.Databases")
    except ValueError:
        pass
    base_services = [
        "datalineup_engine.worker.services.databases.Databases",
        "datalineup_engine.worker.services.api_client.StandaloneApiClient",
    ] + base_services
