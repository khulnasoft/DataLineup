...
class TracerConfig(Service[BaseServices, "TracerConfig.Options"]):
    ...
    async def open(self) -> None:
        from .sampler import ParentBasedDatalineupSampler
        ...
        self.setup_tracer(
            ...
            sampler=ParentBasedDatalineupSampler(),
            service_name="datalineup_worker",
        )
    ...
    def on_executor_initialized(
        ...
        cls.setup_tracer(
            ...
            service_name="datalineup_executor",
        )
