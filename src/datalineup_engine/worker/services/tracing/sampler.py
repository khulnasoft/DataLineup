...
class DatalineupSampler(sampling.Sampler):
    def should_sample(
        self,
        ...
        sampling_rate = attributes.get("datalineup.sampling.rate")
    ...
    def get_description(self) -> str:
        return "DatalineupSampler"


class ParentBasedDatalineupSampler(sampling.ParentBased):
    """
