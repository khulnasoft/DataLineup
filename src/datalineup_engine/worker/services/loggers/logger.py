...
from datalineup_engine.worker.services.tracing import get_trace_context
...
class Logger(Service[BaseServices, "Logger.Options"]):
    ...
    async def open(self) -> None:
        self.message_logger = logging.getLogger("datalineup.messages")
        self.engine_logger = logging.getLogger("datalineup.engine")
...
class PipelineLogger:
    def __init__(self, *, verbose: bool = False) -> None:
        self.logger = logging.getLogger("datalineup.pipeline")
