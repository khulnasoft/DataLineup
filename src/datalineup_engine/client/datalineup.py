...
from datalineup_engine.utils import LONG_TIMEOUT
from datalineup_engine.utils import MEDIUM_TIMEOUT
from datalineup_engine.utils import urlcat
from datalineup_engine.utils.log import getLogger
from datalineup_engine.utils.options import fromdict
from datalineup_engine.worker.services.http_client import HttpClient
from datalineup_engine.worker.services.loggers.logger import topic_message_data
    ...
    def __init__(
        ...
        *,
        ...
        self._loop_thread = threading.Thread(
            target=self._run_loop, name="datalineup-client", daemon=True
        )
