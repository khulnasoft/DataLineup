...
from datalineup_engine.core.api import JobsStates
...
from datalineup_engine.models import Job
from datalineup_engine.models.job_cursor_state import JobCursorState
